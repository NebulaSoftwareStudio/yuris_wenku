        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.status == "success") {
                    ...
                    notification_bar_dom.innerText = '上传成功';
                ...
                if (data.status == "error") {
                    ...
                    notification_bar_dom.innerText = data.msg;
                    notification_bar.animate({top: "0px"}, 200);
                    setTimeout(function () {
                        $("#notification_bar").animate({top: "-50px"}, 200);
                    }, 2000);
...
function save_article(id) {
    ...
    if($('.summernote').summernote('isEmpty')){
        notification_bar_dom.classList = 'alert bg-danger text-white text-center border-0';
        notification_bar_dom.innerText = '请编辑文章正文';
        notification_bar.animate({top: "0px"}, 200);
        setTimeout(function () {
            $("#notification_bar").animate({top: "-50px"}, 200);
        }, 2000);
        ...
        notification_bar_dom.classList = 'alert bg-danger text-white text-center border-0';
        notification_bar_dom.innerText = '请编辑文章标题';
        notification_bar.animate({top: "0px"}, 200);
        setTimeout(function () {
            $("#notification_bar").animate({top: "-50px"}, 200);
        }, 2000);
        ...
        notification_bar_dom.classList = 'alert bg-danger text-white text-center border-0';
        notification_bar_dom.innerText = '请编辑文章概述';
        notification_bar.animate({top: "0px"}, 200);
        setTimeout(function () {
            $("#notification_bar").animate({top: "-50px"}, 200);
        }, 2000);
        ...
        xhr.onreadystatechange = function (e) {
            if (xhr.readyState===4 && xhr.status===200){
                ...
                if(data["status"] === true){
                    notification_bar_dom.classList = 'alert bg-success text-white text-center border-0';
                    notification_bar_dom.innerText = data.info;
                    notification_bar.animate({top: "0px"}, 200);
                    setTimeout(function () {
                        $("#notification_bar").animate({top: "-50px"}, 200);
                    }, 2000);
                    ...
                    notification_bar_dom.classList = 'alert bg-danger text-white text-center border-0';
                    notification_bar_dom.innerText = '保存失败 '+data.info;
                    notification_bar.animate({top: "0px"}, 200);
                    setTimeout(function () {
                        $("#notification_bar").animate({top: "-50px"}, 200);
                    }, 2000);
...
function delete_article() {
    ...
    if(id !== null){
        ...
        xhr.onreadystatechange = function (e) {
            if (xhr.readyState===4 && xhr.status===200){
                ...
                if(data["status"] === true){
                    ...
                    notification_bar_dom.classList = 'alert bg-danger text-white text-center border-0';
                    notification_bar_dom.innerText = '操作失败 '+data.info;
                    notification_bar.animate({top: "0px"}, 200);
                    setTimeout(function () {
                        $("#notification_bar").animate({top: "-50px"}, 200);
                    }, 2000);
        ...
        notification_bar_dom.classList = 'alert bg-danger text-white text-center border-0';
        notification_bar_dom.innerText = '程序错误，请刷新页面重试';
        notification_bar.animate({top: "0px"}, 200);
        setTimeout(function () {
            $("#notification_bar").animate({top: "-50px"}, 200);
        }, 2000);
