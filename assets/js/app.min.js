...
$(document).ready(function () {
    ...
    if (isMobile() && $("html").addClass("ismobile"), $('[data-toggle="tooltip"]')[0] && $('[data-toggle="tooltip"]').tooltip(), $(".search__type")[0] && $('.search__type input[type="radio"]').on("change", function () {
        ...
        }, {breakpoint: 700, settings: {slidesToShow: 2, slidesToScroll: 2, dots: !0, arrows: !1}}, {
            breakpoint: 550,
            settings: {slidesToShow: 1, slidesToScroll: 1, dots: !0, arrows: !1}
        }]
        ...
        var breakPoint = $(this).data("rmd-breakpoint"), target = $(this),
