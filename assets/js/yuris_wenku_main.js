...
function login_in_pages() {
    ...
    // let request_body = {"user_name":user_name,"password":password,"captcha":captcha};
...
function change_captcha(){
    document.getElementById("captcha_image").src = 'common/captcha.php?time='+new Date().getTime();
}
